...
public class MailAvisoCoordenacao {
    ...
    private static String mensagemEmail = "<!DOCTYPE html>\n"
            ...
            + "\n"
            + "        <title>mailAvisoCoordenacao</title>\n"
            + "        <style type=\"text/css\">\n"
            ...
            + "                                                            <br/>\n"
            + "                                                            O aluno <strong>[NOME_ALUNO]</strong> do curso de <strong>[CURSO]</strong> submeteu o <strong>[TIPO_RELATORIO]</strong> referente ao projeto <strong>[TITULO_DO_PROJETO]</strong> \n"
            + "                                                            de nº <strong>[NUMERO_PROJETO]</strong>.\n"
            + "                                                            <br />\n"
            + "                                                            <br />\n"
            + "                                                            <br />\n"
            + "                                                        </div>\n"
    ...
    public static boolean enviarEmailAvisoCoordenacao(String emailDestinatario, String tituloProjeto, String tipoRelatorio,String numeroProjeto, String nomeAluno, String curso, String ano) {

        SendMail mail = new SendMail();
        String remetente = "disparador.email@universidade.edu.br";
        String usuario = remetente;
        String senha = "6745@../#$75";
        String assunto = "PLATAFORMA DE PROJETOS DA PROPES - SUBMISSÃO DE RELATÓRIO";

        String mensagemFinal = mensagemEmail;
        mensagemFinal = mensagemFinal.replace("[TITULO_DO_PROJETO]", tituloProjeto);
        mensagemFinal = mensagemFinal.replace("[TIPO_RELATORIO]", tipoRelatorio);
