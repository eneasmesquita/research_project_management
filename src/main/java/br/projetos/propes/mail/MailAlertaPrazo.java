...
public class MailAlertaPrazo {
    ...
    private static String mensagemEmail = "<!DOCTYPE html>\n"
            ...
            + "                                                            <h3 class=\"h3\">Prezado [NOME_ALUNO],</h3>\n"
            + "                                                            <br/>\n"
            + "                                                                Este e-mail é para lembrá-lo que faltam <strong>[DIAS]</strong> dias para expirar o prazo de envio do <strong>[TIPO_DE_RELATORIO]</strong> \n"
            + "                                                            referente ao seu projeto <strong>[TITULO_DO_PROJETO]</strong> cadastrado em <strong>[dd/MM/yyyy]</strong>.\n"
            + "                                                            <br />\n"
            + "                                                            <br />\n"
            + "                                                            <br/>\n"
            + "                                                        </div>\n"
    ...
    public static boolean enviarEmailAlertaPrazo(String emailDestinatario, String tituloProjeto, String tipoRelatorio, String numeroProjeto, String nomeAluno, String curso, String ano, String dataCadProjeto, String dias) {

        SendMail mail = new SendMail();
        String remetente = "disparador.email@universidade.edu.br";
        String usuario = remetente;
        String senha = "6745@../#$75";
        String assunto = "PLATAFORMA DE PROJETOS DA PROPES - ALERTA PRAZO RELATORIO";
        ...
        mensagemFinal = mensagemFinal.replace("[TIPO_DE_RELATORIO]", tipoRelatorio);
        mensagemFinal = mensagemFinal.replace("[DIAS]", dias);
        mensagemFinal = mensagemFinal.replace("[ANO]", ano);
        mensagemFinal = mensagemFinal.replace("[dd/MM/yyyy]", dataCadProjeto);
