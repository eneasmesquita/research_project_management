...
public class MailAlertaAluno {

    //ESSA CLASSE UTILIZA OS MÉTODOS DA CLASSE SendMail.java
    private static String mensagemEmail = "\n"
            + "<!DOCTYPE html>\n"
            + "            \n"
            + "            <html>\n"
            + "                <head>\n"
            ...
            + "                                                                        <br/>\n"
            + "                                                                        Uma nova movimentação foi adicionada ao seu projeto <strong>[TITULO_DO_PROJETO]</strong><br/>, de nº <strong>[NUMERO_PROJETO]</strong>. \n"
            + "                                                                        <br />\n"
            + "                                                                        <br />\n"
            + "                                                                        <br />\n"
            + "                                                                    </div>\n"
    ...
    public static boolean enviarEmailAlertaAluno(String emailDestinatario, String tituloProjeto, String numeroProjeto, String nomeAluno, String ano) {

        SendMail mail = new SendMail();
        String remetente = "disparador.email@universidade.edu.br";
        String usuario = remetente;
        String senha = "6745@../#$75";
        String assunto = "PLATAFORMA DE PROJETOS DA PROPES - NOVA MOVIMENTAÇÃO";
